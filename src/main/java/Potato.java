...
public class Potato extends JComponent {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                Potato meter = new Potato();
                meter.setPreferredSize(new Dimension(1500, 900));
    ...
    static class Recorder implements Runnable {
        ...
        public void run() {
            ...
            for (Mixer.Info info: infos) {
                ...
                try {
                    System.out.println(AudioSystem.getSourceDataLine(fmt, info).getLineInfo());
                } catch (LineUnavailableException e) {
                    e.printStackTrace();
                }
                System.out.println("");
